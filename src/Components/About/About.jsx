  ...
  return (
    <div className='about'>
        <div className='about-left'>
            <img src={about_img} alt="about_img" className='image'/>
        ...
        <div className='about-right'>
            ...
            <button className='about-btn'>KNOW MORE <img src= {white_arrow} alt="" className='white_arrow'/> <img src= {dark_arrow} alt="" className='dark_arrow'/></button>
        </div>
    </div>
  )
}
